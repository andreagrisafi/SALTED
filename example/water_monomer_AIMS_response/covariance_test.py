...
# select Wigner-D matrix for the given L
L = 1
msize = 2*L+1
...
np.save("Dreal_L1_from_"+str(itest)+"_to_0.npy",D_real)
...
cvec_1 = np.zeros(3)
cvec_1[0] = np.load(path2qm+"coefficients/x/coefficients_conf0.npy")[0]
cvec_1[1] = np.load(path2qm+"coefficients/y/coefficients_conf0.npy")[0]
cvec_1[2] = np.load(path2qm+"coefficients/z/coefficients_conf0.npy")[0]

cvec_2 = np.zeros(3)
cvec_2[0] = np.load(path2qm+"coefficients/x/coefficients_conf1.npy")[0]
cvec_2[1] = np.load(path2qm+"coefficients/y/coefficients_conf1.npy")[0]
cvec_2[2] = np.load(path2qm+"coefficients/z/coefficients_conf1.npy")[0]

print(cvec_1)
print(np.dot(rmat,cvec_2))
print("error:")
print(np.dot(rmat,cvec_2)-cvec_1)
...
cvec_1 = np.zeros((3,3))
cvec_1[0,:] = np.load(path2qm+"coefficients/x/coefficients_conf0.npy")[9:12]
cvec_1[1,:] = np.load(path2qm+"coefficients/y/coefficients_conf0.npy")[9:12]
cvec_1[2,:] = np.load(path2qm+"coefficients/z/coefficients_conf0.npy")[9:12]

cvec_2 = np.zeros((3,3))
cvec_2[0,:] = np.load(path2qm+"coefficients/x/coefficients_conf1.npy")[9:12]
cvec_2[1,:] = np.load(path2qm+"coefficients/y/coefficients_conf1.npy")[9:12]
cvec_2[2,:] = np.load(path2qm+"coefficients/z/coefficients_conf1.npy")[9:12]

print(cvec_1)
print(np.dot(rmat,np.dot(cvec_2,D_real.T)))
print("error:")
print(np.dot(rmat,np.dot(cvec_2,D_real.T))-cvec_1)
