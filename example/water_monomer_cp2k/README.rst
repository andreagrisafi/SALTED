...
7. Set the :code:`inp.qm.coeffile` and :code:`inp.qm.ovlpfile` input arguments according to the filenames of the RI density-fitting coefficients and 2-center RI integrals generated at 4. Then, convert thefull training dataset in SALTED format by running:
