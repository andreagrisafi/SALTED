...
for iconf in testrange:
    ...
    projs = np.load("projections/projections_conf"+str(iconf)+".npy")
    ...
    coords /= bohr2ang
    auxmol = gto.M(atom=catoms,basis="cc-pvqz jkfit")
    ...
    E_H_ab = np.loadtxt("qm-runs/conf_"+str(iconf+1)+"/hartree_energy.dat")
    ...
    E_eN_ab = np.loadtxt("qm-runs/conf_"+str(iconf+1)+"/external_energy.dat")
